...
export default function ShiftApp() {
  ...
  const [monthlyAssignment] = useState<MonthlyAssignment>({
  ...
  useEffect(() => {
    ...
    if (savedMonthly) {
      try {
        // monthlyAssignmentは使用されていますが、setMonthlyAssignmentが定義されていないため、
        // ここでは読み込みをスキップします
        console.log('Monthly assignment loaded:', savedMonthly);
      } catch (e) {
