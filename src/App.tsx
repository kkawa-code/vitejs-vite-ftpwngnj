...
const KEY_ALL_DAYS = "shifto_alldays_v2460"; const KEY_MONTHLY = "shifto_monthly_v2460"; const KEY_RULES = "shifto_rules_v2460";
...
class AutoAssigner {
  ...
  processPostTasks() {
    ...
    const isFixedToAnyGeneral = (staffName: string) => (this.ctx.customRules.fixed || []).some((r:any) => r.staff === staffName);
    ...
    unassignedGeneral.forEach((staff: string) => {
      ...
      for (const room of deKenmuTargets) {
        ...
        const candidateToReplaceIdx = currentMems.findIndex(m => {
          ...
          if (isFixedToAnyGeneral(core)) return false;
  ...
  return (
    <div style={{ maxWidth: "98%", margin: "0 auto", padding: "24px", boxSizing: "border-box" }}>
      ...
      <div className="no-print" style={{ ...panelStyle(), display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24, padding: "20px 32px", background: "linear-gradient(to right, #ffffff, #f8fafc)" }}>
        <h2 style={{ margin: 0, color: "#0f172a", fontSize: 24, fontWeight: 900 }}>勤務割付システム Ver 2.45</h2>
