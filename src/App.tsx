...
const FALLBACK_HOLIDAYS: Record<string, string> = {
  "2025-01-01": "元日", "2025-01-13": "成人の日", "2025-02-11": "建国記念の日", "2025-02-23": "天皇誕生日", "2025-02-24": "振替休日", "2025-03-20": "春分の日", "2025-04-29": "昭和の日", "2025-05-03": "憲法記念日", "2025-05-04": "みどりの日", "2025-05-05": "こどもの日", "2025-05-06": "振替休日"
};
...
const KEY_ALL_DAYS = "shifto_alldays_v102"; 
const KEY_MONTHLY = "shifto_monthly_v102"; 
const KEY_RULES = "shifto_rules_v102";
        ...
        <div style={{ ...panelStyle(), padding: "16px 20px" }}>
          <details>
            <summary style={{ fontWeight: 800, color: "#4338ca", padding: "4px", fontSize: 16, display: "flex", alignItems: "center", gap: 8, letterSpacing: "0.02em" }}>
              <span>🍱</span> ② 日々の業務ルール（昼当番・遅番・サポート）
            </summary>
